...
const Salons = () => {
  ...
  return (
    <div className='w-full'>
      <div className='text-2xl text-violet-600 font-bold text-center p-3 rounded-md shadow-md '>Nasze salony sprzedaży</div>
      <div className='w-full'>
          ...
          salonsList.map((salon, index) => {
            return (
              <div key={index} className='w-full p-2 py-4 rounded-md shadow-lg md:w-2/5'>
                <div className='font-semibold text-gray-500 text-center text-2xl'>{salon.location.zipCode+' '+salon.location.city+' '+salon.location.street}</div>
